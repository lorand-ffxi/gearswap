...
function init_gear_sets()
    ...
    sets.wsBase['Apex Arrow'] = {   --AGI
        ...
        back="Kayapa Cape",         waist="Sveltesse Gouriz",   legs="Otronif Brais +1",    feet="Otronif Boots +1"
    }
    ...
    sets.weapons['4-Hit'] = {main="Amanomurakumo", sub="Duplus Grip", range="Cibitshavore", ammo="Eminent Arrow"}
    sets.weapons['5-Hit'] = {main="Amanomurakumo", sub="Duplus Grip", ammo="Potestas Bomblet"}
    ...
    sets.engaged['4-Hit'].with_buff['hasso'] = {head="Yaoyotl Helm", legs="Kasuga Haidate"}
