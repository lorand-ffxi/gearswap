...
function init_gear_sets()
	...
	sets.precast.JA['Sneak Attack'] = {
		...
		back="Kayapa Cape",			waist="Warwolf Belt",		legs="Raider's Culottes +2",feet="Shneddick Boots +1"
	}

	sets.precast.JA['Trick Attack'] = {
		head="Uk'uxkaj Cap",		neck="Hope Torque",			ear2="Suppanomimi",
		body="Shneddick Tabard +1",	hands="Iuitl Wristbands",	ring1="Stormsoul Ring",	ring2="Blobnag Ring",
	...
	--Snapshot
	sets.precast.RangedAttack = {hands="Iuitl Wristbands"}

	sets.wsBase = {
		head="Iuitl Headgear",	neck="Asperity Necklace",		ear1="Steelflash Earring",	ear2="Bladeborn Earring",
		body="Iuitl Vest",		hands="Plunderer's Armlets +1",	ring1="Rajas Ring",			ring2="Epona's Ring",
	...
	sets.midcast.RangedAttack = {
		...
		body="Iuitl Vest",		hands="Buremte Gloves",	ring2="Longshot Ring",
	...
	sets.idle = {
		...
		body="Thaumas Coat",			hands="Plunderer's Armlets +1",	ring1="Defending Ring",		ring2="Sheltered Ring",
		back="Repulse Mantle",			waist="Flume Belt",				legs="Kaabnax Trousers",	feet="Pillager's Poulaines"
	}
	sets.idle.Speedy = set_combine(sets.idle, {feet="Pillager's Poulaines"})
	...
	sets.engaged = {
		...
		body="Thaumas Coat",		hands="Plunderer's Armlets +1",	ring1="Rajas Ring",			ring2="Epona's Ring",
