...
instruments.string = S{'Terpander', "Crooner's Cithara", 'Vihuela', 'Oneiros Harp', 'Sorrowful Harp', 'Rose Harp', 'Rose Harp +1'}

instruments.wind = S{
	'Traversiere', 'Traversiere +1', 'Cornette', 'Cornette +1', 'Hellish Bugle', 'Hellish Bugle +1',
	'Crumhorn', 'Crumhorn +1', 'Iron Ram Horn', "Harlequin's Horn", "Apollo's Flute", 'Shofar', "Pan's Horn",
	'Syrinx', "Cantabank's Horn", 'Faerie Piccolo', 'Eminent Flute'
}
...
elements.nuke_of = {	['Light']='Banish',			['Dark']=nil,				['Fire']='Fire',				['Ice']='Blizzard',
						['Wind']='Aero',			['Earth']='Stone',			['Lightning']='Thunder',		['Water']='Water'
}
elements.nukega_of = {	['Light']='Banishga',		['Dark']=nil,				['Fire']='Firaga',				['Ice']='Blizzaga',
						['Wind']='Aeroga',			['Earth']='Stonega',		['Lightning']='Thundaga',		['Water']='Waterga'
}
elements.nukeja_of = {	['Light']=nil,				['Dark']=nil,				['Fire']='Firaja',				['Ice']='Blizzaja',
						['Wind']='Aeroja',			['Earth']='Stoneja',		['Lightning']='Thundaja',		['Water']='Waterja'
}
elements.weak_to = {	['Light']='Dark',			['Dark']='Light',			['Fire']='Ice',					['Ice']='Wind',
						['Wind']='Earth',			['Earth']='Lightning',		['Lightning']='Water',			['Water']='Fire'
}
elements.strong_to = {	['Light']='Dark',			['Dark']='Light',			['Fire']='Water',				['Ice']='Fire',
						['Wind']='Ice',				['Earth']='Wind',			['Lightning']='Earth',			['Water']='Lightning'
}
elements.storm_of = {	['Light']="Aurorastorm",	['Dark']="Voidstorm",		['Fire']="Firestorm",			['Ice']="Hailstorm",
						['Wind']="Windstorm",		['Earth']="Sandstorm",		['Lightning']="Thunderstorm",	['Water']="Rainstorm"
}
elements.spirit_of = {	['Light']="Light Spirit",	['Dark']="Dark Spirit",		['Fire']="Fire Spirit",			['Ice']="Ice Spirit",
						['Wind']="Air Spirit",		['Earth']="Earth Spirit",	['Lightning']="Thunder Spirit",	['Water']="Water Spirit",
}
...
bow_gun_weaponskills = S{
	...
	"Jishnu's Radiance","Hot Shot",			"Split Shot",		"Sniper Shot",	"Slug Shot",
	"Blast Shot",		"Heavy Shot",		"Detonator",		"Numbing Shot",	"Last Stand",
...
ranged_weaponskills = S{
	...
	"Hot Shot",			"Split Shot",		"Sniper Shot",		"Slug Shot",	"Heavy Shot",
	"Detonator",		"Last Stand",		"Coronach",			"Trueflight",	"Leaden Salute",
	"Wildfire",			"Myrkr"
}
...
var_potency_enfeebs = S{
	'Slow', 'Slow II', 'Paralyze', 'Paralyze II', 'Addle'
}
...
npcs = {}
npcs.Trust = S{
	'Ayame','Naji','Nanaa Mihgo','Tenzen','Volker','Zeid','Ajido-Marujido','Shantotto',
	'Curilla','Excenmille','Trion','Valaineral','Kupipi','Mihli Aliapoh','Joachim','Lion'
}
