...
spell_maps = {
    ...
    --New
    ['Dia']='Dia',                  ['Dia II']='Dia',               ['Dia III']='Dia',                  ['Dia IV']='Dia',               ['Dia V']='Dia',
    ['Banish IV']='Banish',         ['Banish V']='Banish',          ['Diaga']='Dia',                    ['Diaga II']='Dia',             ['Diaga III']='Dia',
    ['Diaga IV']='Dia',             ['Diaga V']='Dia',              ['Banishga III']='Banish',          ['Banishga IV']='Banish',       ['Banishga V']='Banish',
    ['Barsleep']='BarStatus',       ['Barpoison']='BarStatus',      ['Barparalyze']='BarStatus',        ['Barblind']='BarStatus',       ['Barsilence']='BarStatus',
    ['Barpetrify']='BarStatus',     ['Barvirus']='BarStatus',       ['Baramnesia']='BarStatus',         ['Baramnesra']='BarStatus',     ['Barsleepra']='BarStatus',
    ['Barpoisonra']='BarStatus',    ['Barparalyzra']='BarStatus',   ['Barblindra']='BarStatus',         ['Barsilencera']='BarStatus',   ['Barpetra']='BarStatus',
    ['Barvira']='BarStatus',        ['Sacrifice']='StatusRemoval',  ['Esuna']='StatusRemoval',          ['Enfire']='EnElement',         ['Enblizzard']='EnElement',
    ['Enaero']='EnElement',         ['Enstone']='EnElement',        ['Enthunder']='EnElement',          ['Enwater']='EnElement',        ['Invisible']='Stealth',
    ['Sneak']='Stealth',            ['Deodorize']='Stealth',        ['Flare']='AM',                     ['Flare II']='AM2',             ['Freeze']='AM',
    ['Freeze II']='AM2',            ['Tornado']='AM',               ['Tornado II']='AM2',               ['Quake']='AM',                 ['Quake II']='AM2',
    ['Burst']='AM',                 ['Burst II']='AM2',             ['Flood']='AM',                     ['Flood II']='AM2',             ['Poison']='Poison',
    ['Poison II']='Poison',         ['Poison III']='Poison',        ['Poison IV']='Poison',             ['Poison V']='Poison',          ['Poisonga']='Poison',
    ['Poisonga II']='Poison',       ['Poisonga III']='Poison',      ['Poisonga IV']='Poison',           ['Poisonga V']='Poison',        ['Bio']='Bio',
    ['Bio II']='Bio',               ['Bio III']='Bio',              ['Bio IV']='Bio',                   ['Bio V']='Bio',                ['Absorb-ACC']='Absorb',
    ['Blaze Spikes']='Spikes',      ['Ice Spikes']='Spikes',        ['Shock Spikes']='Spikes',          ['Absorb-STR']='Absorb',        ['Absorb-DEX']='Absorb',
    ['Absorb-VIT']='Absorb',        ['Absorb-AGI']='Absorb',        ['Absorb-INT']='Absorb',            ['Absorb-MND']='Absorb',        ['Absorb-CHR']='Absorb',
    ['Dread Spikes']='Spikes',      ['Fire Spirit']='Spirit',       ['Ice Spirit']='Spirit',            ['Air Spirit']='Spirit',        ['Earth Spirit']='Spirit',
    ['Thunder Spirit']='Spirit',    ['Water Spirit']='Spirit',      ['Light Spirit']='Spirit',          ['Dark Spirit']='Spirit',       ['Carbuncle']='Avatar',
    ['Fenrir']='Avatar',            ['Ifrit']='Avatar',             ['Titan']='Avatar',                 ['Leviathan']='Avatar',         ['Garuda']='Avatar',
    ['Shiva']='Avatar',             ['Ramuh']='Avatar',             ['Diabolos']='Avatar',              ['Odin']='Avatar',              ['Alexander']='Avatar',
    ['Cait Sith']='Avatar',         ['Enlight']='EnElement',        ['Endark']='EnElement',             ['Enfire II']='EnElement2',     ['Enblizzard II']='EnElement2',
    ['Enaero II']='EnElement2',     ['Enstone II']='EnElement2',    ['Enthunder II']='EnElement2',      ['Enwater II']='EnElement2',    ['Utsusemi: San']='Utsusemi',
    ['Jubaku: Ni']='NinEnfeeb',     ['Jubaku: San']='NinEnfeeb',    ['Hojo: San']='NinEnfeeb',          ['Kurayami: San']='NinEnfeeb',  ['Dokumori: Ni']='NinEnfeeb',
    ['Dokumori: San']='NinEnfeeb',  ['Tonko: San']='NinBuff',
    ['Foe Requiem VIII']='Requiem', ["Army's Paeon VII"]='Paeon',   ["Army's Paeon VIII"]='Paeon',      ['Fowl Aubade']='Aubade',       ['Herb Pastoral']='Pastoral',
    ['Shining Fantasia']='Fantasia',["Scop's Operetta"]='Operetta', ["Puppet's Operetta"]='Operetta',   ["Jester's Operetta"]='Operetta',
    ['Gold Capriccio']='Capriccio', ['Devotee Serenade']='Serenade',['Warding Round']='Round',          ['Goblin Gavotte']='Gavotte',
    ['Cactuar Fugue']='Fugue',      ['Honor March']='March',        ['Protected Aria']='Aria',          ['Massacre Elegy']='Elegy',     ['Ltng. Threnody']='Threnody',
    ["Maiden's Virelai"]='Virelai', ['Foe Sirvente']='Sirvente',    ["Adventurer's Dirge"]='Dirge',
    ['Boost-STR']='Boost',          ['Boost-DEX']='Boost',          ['Boost-VIT']='Boost',              ['Boost-AGI']='Boost',          ['Boost-INT']='Boost',
    ['Boost-MND']='Boost',          ['Boost-CHR']='Boost',          ['Gain-STR']='Gain',                ['Gain-DEX']='Gain',            ['Gain-VIT']='Gain',
    ['Gain-AGI']='Gain',            ['Gain-INT']='Gain',            ['Gain-MND']='Gain',                ['Gain-CHR']='Gain',
    ['Gekka: Ichi']='NinBuff',      ['Yain: Ichi']='NinBuff',       ['Atomos']='Avatar',                ['Reraise IV']='Reraise',
    ['Enlight II']='EnElement2',    ['Endark II']='EnElement2',
    ['Sandstorm II']='Storm2',      ['Rainstorm II']='Storm2',      ['Windstorm II']='Storm2',          ['Firestorm II']='Storm2',      ['Hailstorm II']='Storm2',
    ['Thunderstorm II']='Storm2',   ['Voidstorm II']='Storm2',      ['Aurorastorm II']='Storm2',        ['Fire Threnody II']='Threnody',
    ['Ice Threnody II']='Threnody', ['Wind Threnody II']='Threnody',['Earth Threnody II']='Threnody',   ['Ltng. Threnody II']='Threnody',
    ['Water Threnody II']='Threnody',                               ['Light Threnody II']='Threnody',   ['Dark Threnody II']='Threnody',
    ['Drain III']='Drain',          ['Aspir III']='Aspir',          ['Geohelix II']='Helix2',           ['Hydrohelix II']='Helix2',     ['Anemohelix II']='Helix2',
    ['Pyrohelix II']='Helix2',      ['Cryohelix II']='Helix2',      ['Ionohelix II']='Helix2',          ['Noctohelix II']='Helix2',     ['Luminohelix II']='Helix2',
    ['Full Cure']='Cure',           ['Refresh III']='Refresh',
}
...
blu_statmap = {
    ...
    ["Whirl of Rage"]="STRMND",["Wild Oats"]="AGI",["Anvil Lightning"]="DEX",["Blinding Fulgor"]="STRDEXAGI",
    ["Bloodrake"]="STR",["Embalming Earth"]="INT",["Final Sting"]="HP",["Polar Roar"]="STRINT",
    ["Retinal Glare"]="INT",["Searing Tempest"]="STR",["Self-Destruct"]="HP",["Silent Storm"]="AGI",
...
blu_typemap = {
    ...
    ["Absolute Terror"]="Enfeeb",["Actinic Burst"]="Enfeeb",["Atra. Libations"]="Drain",["Blank Gaze"]="Enfeeb",
    ["Blood Drain"]="Drain",["Blood Saber"]="Drain",["Carcharian Verve"]="Buff",["Cruel Joke"]="Debuff",
    ["Demoralizing Roar"]="Debuff",["Digest"]="Drain",["Feather Tickle"]="Debuff",["Geist Wall"]="Enfeeb",
    ["Jettatura"]="Enfeeb",["Mighty Guard"]="Buff",["MP Drainkiss"]="Drain",["Osmosis"]="Drain",
    ["Plasma Charge"]="Buff",["Reaving Wind"]="Debuff",["Sound Blast"]="Debuff",["Stinking Gas"]="Debuff",
    ["Temporal Shift"]="Debuff",["Voracious Trunk"]="Debuff",["Wild Carrot"]="Heal"
}

--[[
    BLU spells not listed above (no modifiers or not discovered; base physical
    set should include STR and base magic set should include INT):
    1000 Needles, Bilgestorm, Blistering Roar, Cesspool, Crashing Thunder
    Droning Whirlwind, Entomb, Foul Waters, Molting Plumage, Nectarous Deluge
    Palling Salvo, Paralyzing Triad, Rending Deluge, Saurian Slide
    Scouring Spate, Sweeping Gouge, Tearing Gust, Uproot
--]]
